      ...
      <div className="min-h-[100dvh] flex flex-col items-center justify-center px-6 bg-[var(--admin-bg)]">
        <div className="w-full max-w-xs space-y-6">
          <div className="text-center">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[var(--color-navy)] flex items-center justify-center">
            ...
            <p className="text-sm text-[var(--admin-text-secondary)] mt-1">
              Enter your 6-digit volunteer PIN
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl font-semibold text-sm bg-[var(--color-navy)] text-white hover:bg-[var(--color-navy)]/90 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[10px] text-white/60">
              Gate: {staff?.assigned_gate || "Main"} • {scanCount} scans
            </div>
          </div>
        </div>
        ...
        {!showManual ? (
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-white text-lg font-bold">Manual Check-In</h2>
              <button
                onClick={() => {
                  setShowManual(false);
                  startCamera();
              ...
              >
                <RotateCcw className="w-3.5 h-3.5" /> Back to Scanner
              </button>
            </div>
            ...
            <div className="flex gap-2">
              <input
                type="text"
                placeholder="Registration ID or Phone"
                value={manualSearch}
