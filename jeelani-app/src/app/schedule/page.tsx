    ...
    >
      <div className="flex items-start gap-4">
        <div className="shrink-0 text-center pt-1 min-w-[70px]">
          <p className="text-base font-bold text-[var(--color-navy)] dark:text-[var(--color-turquoise)]">{session.startTime}</p>
          <p className="text-xs text-[var(--text-muted)]">to {session.endTime}</p>
        </div>
        <div className="flex-1">
          <div className="flex items-start gap-2 mb-2 flex-wrap">
            ...
            {session.isPaid && (
              <span className="text-[10px] px-2 py-0.5 rounded-full font-medium bg-[var(--color-brass)]/10 text-[var(--color-brass)] border border-[var(--color-brass)]/20">paid</span>
            )}
          </div>
